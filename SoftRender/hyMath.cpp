...
inline static bool IsPointInTriangle4(Vec2f pointA,Vec2f pointB,Vec2f pointC, Vec2f pointP)
{
    Vec2f PA = Minus(pointA,pointP);
    Vec2f PB = Minus(pointB,pointP);
    Vec2f PC = Minus(pointC,pointP);
    double t1 = CrossProduct(PA,PB);
    double t2 = CrossProduct(PB,PC);
    double t3 = CrossProduct(PC,PA);
