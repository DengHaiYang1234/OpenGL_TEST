...
//        model = glm::rotate(model, (GLfloat)-90, glm::normalize(glm::vec3(1.0, 0.0, 0.0)));
        ...
        lightingShader.set_uniform("height_scale", height_scale);
        lightingShader.set_uniform("bricksTex", 0);
        lightingShader.set_uniform("bricksNormalTex", 1);
        lightingShader.set_uniform("bricksDispTex", 2);
        glActiveTexture(GL_TEXTURE0);
        glBindTexture(GL_TEXTURE_2D, bricksTex);
        glActiveTexture(GL_TEXTURE1);
        glBindTexture(GL_TEXTURE_2D,bricksNormalTex);
        glActiveTexture(GL_TEXTURE2);
        glBindTexture(GL_TEXTURE_2D,bricksDispTex);
        RenderQuad();
