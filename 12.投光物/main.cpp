...
int main(int argc, const char * argv[]) {
    ...
    //世界空间的光照实现
    ShaderProgram lightingShader(ApplicationPath + "12.投光物/lightingVertexWS.glsl",ApplicationPath + "12.投光物/lightingFragmentWS.glsl");
    
    
    ShaderProgram lightShader(ApplicationPath + "12.投光物/lightVertex.glsl",ApplicationPath + "12.投光物/lightFragment.glsl");
